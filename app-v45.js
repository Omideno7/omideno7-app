...
function fastingVerseText(ref){
 const m={
  "Matthew 4:4":{fa:"انسان نه فقط به نان زیست می‌کند، بلکه به هر کلمه‌ای که از دهان خدا صادر گردد.",en:"Man shall not live by bread alone, but by every word that proceeds from the mouth of God.",hr:"Ne živi čovjek samo o kruhu, nego o svakoj riječi koja izlazi iz Božjih usta."},
  "Matthew 6:16-18":{fa:"وقتی روزه می‌گیرید، مانند ریاکاران نباشید. روزه در حضور پدر است، نه برای نمایش انسان‌ها.",en:"When you fast, do not be like the hypocrites. Fasting is before the Father, not for human display.",hr:"Kad postite, ne budite kao licemjeri. Post je pred Ocem, a ne za pokazivanje ljudima."},
  "John 10:27":{fa:"گوسفندان من آواز مرا می‌شنوند و من آنها را می‌شناسم و مرا متابعت می‌کنند.",en:"My sheep hear my voice, and I know them, and they follow me.",hr:"Moje ovce slušaju moj glas; ja ih poznajem i one idu za mnom."},
  "Romans 8:14":{fa:"زیرا همه کسانی که از روح خدا هدایت می‌شوند، پسران خدا هستند.",en:"For as many as are led by the Spirit of God, these are children of God.",hr:"Svi koje vodi Duh Božji sinovi su Božji."},
  "Proverbs 3:5-6":{fa:"با تمامی دل خود بر خداوند توکل نما و بر عقل خود تکیه مکن؛ او راه‌هایت را راست خواهد گردانید.",en:"Trust in the Lord with all your heart; He will direct your paths.",hr:"Uzdaj se u Gospodina svim srcem svojim; on će poravniti tvoje staze."},
  "Romans 10:17":{fa:"ایمان از شنیدن است و شنیدن از کلام خدا.",en:"Faith comes by hearing, and hearing by the Word of God.",hr:"Vjera dolazi od slušanja, a slušanje po Božjoj riječi."},
  "Mark 11:23-24":{fa:"هر که ایمان داشته باشد و در دل خود شک نکند، آنچه بگوید برای او خواهد شد.",en:"Whoever believes and does not doubt in his heart will have what he says.",hr:"Tko vjeruje i ne posumnja u srcu, bit će mu što kaže."},
  "Hebrews 11:1":{fa:"ایمان، اطمینان به چیزهایی است که امید داریم و یقین به چیزهایی که نمی‌بینیم.",en:"Faith is the substance of things hoped for, the evidence of things not seen.",hr:"Vjera je jamstvo onoga čemu se nadamo i dokaz stvarnosti koje ne vidimo."},
  "Isaiah 58:6-12":{fa:"روزه‌ای که خدا می‌پسندد با آزادی، عدالت، رحمت و خدمت به دیگران همراه است.",en:"The fast God chooses is connected with freedom, justice, mercy, and service to others.",hr:"Post koji Bog izabire povezan je sa slobodom, pravdom, milosrđem i služenjem drugima."},
  "Acts 13:2-3":{fa:"در حالی که خدمت خداوند می‌کردند و روزه داشتند، روح‌القدس هدایت خود را آشکار کرد.",en:"As they ministered to the Lord and fasted, the Holy Spirit revealed His guidance.",hr:"Dok su služili Gospodinu i postili, Duh Sveti je objavio svoje vodstvo."},
  "Colossians 3:15":{fa:"صلح خدا در دل‌های شما حکم‌فرما باشد.",en:"Let the peace of God rule in your hearts.",hr:"Neka mir Božji vlada u vašim srcima."},
  "Galatians 6:9":{fa:"از نیکوکاری خسته نشویم، زیرا در زمان مناسب درو خواهیم کرد اگر سست نشویم.",en:"Let us not grow weary in doing good, for in due season we shall reap if we do not give up.",hr:"Ne umarajmo se činiti dobro, jer ćemo u pravo vrijeme žeti ako ne posustanemo."}
 };
 return (m[ref]&& (m[ref][currentLang]||m[ref].en)) || ref;
}
function fastingRefsHtml(item){
 return `<div class="fasting-refs">${item.refs.map(r=>`<details class="plan-scripture-expand"><summary>${r}</summary><p>${fastingVerseText(r)}</p></details>`).join('')}</div>`;
}
...
function renderFastingHome(){
 const x=ft();
 return `<button class="btn light" onclick="selectedPlanKey=null; localStorage.removeItem('selectedPlanKey'); fastingView='home'; localStorage.setItem('fastingView','home'); renderPlans();">← ${currentLang==='fa'?'بازگشت به همه پلن‌ها':currentLang==='hr'?'Natrag na sve planove':'Back to all plans'}</button><div class="hero-card fasting-hero"><h1>${x.title}</h1><p><strong>${x.subtitle}</strong></p><p>${x.intro}</p></div>
...
/* Critical fallback content so pages never open empty */
(function(){
 if(!window.declarationsData || !Array.isArray(window.declarationsData) || !window.declarationsData.length){
 ...
 if(!window.newBirthContentData){
  window.newBirthContentData={
   fa:{title:"تولد تازه و نجات در مسیح",subtitle:"زندگی تازه در عیسی مسیح",sections:[
    {title:"تولد تازه چیست؟",body:"تولد تازه یعنی انسان با ایمان به عیسی مسیح از درون زنده می‌شود و حیات خدا را دریافت می‌کند. این فقط تغییر مذهب نیست؛ آغاز یک زندگی تازه در مسیح است."},
    {title:"نجات در مسیح",body:"نجات هدیه خداست. ما با کارهای مذهبی نجات نمی‌یابیم، بلکه با ایمان به قربانی کامل عیسی مسیح، مرگ و قیام او، نجات را دریافت می‌کنیم."},
    {title:"دعای ایمان",body:"خداوند عیسی، من به تو ایمان دارم. باور دارم که برای من مردی و از مردگان برخاستی. امروز تو را خداوند و نجات‌دهنده زندگی خود اعلام می‌کنم. آمین."}
   ]},
   en:{title:"New Birth and Salvation in Christ",subtitle:"A new life in Jesus Christ",sections:[
    {title:"What is the new birth?",body:"The new birth means a person becomes alive inwardly by faith in Jesus Christ and receives the life of God. It is not merely changing religion; it is the beginning of a new life in Christ."},
    {title:"Salvation in Christ",body:"Salvation is God’s gift. We are not saved by religious works, but by faith in the complete sacrifice, death, and resurrection of Jesus Christ."},
    {title:"Prayer of faith",body:"Lord Jesus, I believe in You. I believe You died for me and rose from the dead. Today I declare You as Lord and Savior of my life. Amen."}
   ]},
   hr:{title:"Novo rođenje i spasenje u Kristu",subtitle:"Novi život u Isusu Kristu",sections:[
    {title:"Što je novo rođenje?",body:"Novo rođenje znači da čovjek po vjeri u Isusa Krista iznutra prima život od Boga. To nije samo promjena religije; to je početak novog života u Kristu."},
    {title:"Spasenje u Kristu",body:"Spasenje je Božji dar. Ne spašavamo se religioznim djelima, nego vjerom u savršenu žrtvu, smrt i uskrsnuće Isusa Krista."},
    {title:"Molitva vjere",body:"Gospodine Isuse, vjerujem u Tebe. Vjerujem da si umro za mene i uskrsnuo od mrtvih. Danas Te priznajem kao Gospodina i Spasitelja svog života. Amen."}
   ]},
   videos:[]
  };
 }
 if(!window.teachingPlans || !Object.keys(window.teachingPlans).length){
  window.teachingPlans={
   wordLife:{
    fa:{title:"رشد روزانه در کلام",subtitle:"۷ روز برای تمرکز روی کلام خدا",intro:"این پلن به شما کمک می‌کند هر روز با آیه، دعا و قدم عملی در کلام رشد کنید.",days:[
     {day:1,title:"کلام، غذای روح",scriptures:[{ref:{fa:"متی ۴:۴",en:"Matthew 4:4",hr:"Matej 4,4"},text:{fa:"انسان نه فقط به نان زیست می‌کند، بلکه به هر کلمه‌ای که از دهان خدا صادر گردد.",en:"Man shall not live by bread alone, but by every word that proceeds from the mouth of God.",hr:"Ne živi čovjek samo o kruhu, nego o svakoj riječi koja izlazi iz Božjih usta."}}],devotional:"روح انسان با کلام خدا تقویت می‌شود.",step:"امروز ۱۰ دقیقه روی یک آیه تعمق کن.",prayer:"پدر، قلبم را برای کلامت باز کن.",declaration:"کلام خدا در من زنده و فعال است."},
     {day:2,title:"ایمان از شنیدن است",scriptures:[{ref:{fa:"رومیان ۱۰:۱۷",en:"Romans 10:17",hr:"Rimljanima 10,17"},text:{fa:"ایمان از شنیدن است و شنیدن از کلام خدا.",en:"Faith comes by hearing, and hearing by the Word of God.",hr:"Vjera dolazi od slušanja, a slušanje po Božjoj riječi."}}],devotional:"هرچه بیشتر کلام را بشنوی، ایمان تو قوی‌تر می‌شود.",step:"یک آیه را با صدای بلند بخوان.",prayer:"خداوندا ایمان مرا با کلامت تقویت کن.",declaration:"ایمان من هر روز قوی‌تر می‌شود."}
    ]},
    en:{title:"Daily Growth in the Word",subtitle:"7 days of focus on God’s Word",intro:"This plan helps you grow daily through Scripture, prayer, and practical steps.",days:[
     {day:1,title:"The Word, food for the spirit",scriptures:[{ref:{fa:"متی ۴:۴",en:"Matthew 4:4",hr:"Matej 4,4"},text:{fa:"انسان نه فقط به نان زیست می‌کند، بلکه به هر کلمه‌ای که از دهان خدا صادر گردد.",en:"Man shall not live by bread alone, but by every word that proceeds from the mouth of God.",hr:"Ne živi čovjek samo o kruhu, nego o svakoj riječi koja izlazi iz Božjih usta."}}],devotional:"The human spirit is strengthened by God’s Word.",step:"Meditate on one verse for 10 minutes today.",prayer:"Father, open my heart to Your Word.",declaration:"God’s Word is alive and active in me."},
     {day:2,title:"Faith comes by hearing",scriptures:[{ref:{fa:"رومیان ۱۰:۱۷",en:"Romans 10:17",hr:"Rimljanima 10,17"},text:{fa:"ایمان از شنیدن است و شنیدن از کلام خدا.",en:"Faith comes by hearing, and hearing by the Word of God.",hr:"Vjera dolazi od slušanja, a slušanje po Božjoj riječi."}}],devotional:"The more you hear the Word, the stronger your faith becomes.",step:"Read one verse aloud.",prayer:"Lord, strengthen my faith through Your Word.",declaration:"My faith grows stronger every day."}
    ]},
    hr:{title:"Dnevni rast u Riječi",subtitle:"7 dana fokusa na Božju riječ",intro:"Ovaj plan pomaže vam svakodnevno rasti kroz stih, molitvu i praktičan korak.",days:[
     {day:1,title:"Riječ, hrana za duh",scriptures:[{ref:{fa:"متی ۴:۴",en:"Matthew 4:4",hr:"Matej 4,4"},text:{fa:"انسان نه فقط به نان زیست می‌کند، بلکه به هر کلمه‌ای که از دهان خدا صادر گردد.",en:"Man shall not live by bread alone, but by every word that proceeds from the mouth of God.",hr:"Ne živi čovjek samo o kruhu, nego o svakoj riječi koja izlazi iz Božjih usta."}}],devotional:"Ljudski duh jača Božjom riječju.",step:"Danas 10 minuta razmišljaj o jednom stihu.",prayer:"Oče, otvori moje srce za svoju Riječ.",declaration:"Božja riječ je živa i djelotvorna u meni."},
     {day:2,title:"Vjera dolazi slušanjem",scriptures:[{ref:{fa:"رومیان ۱۰:۱۷",en:"Romans 10:17",hr:"Rimljanima 10,17"},text:{fa:"ایمان از شنیدن است و شنیدن از کلام خدا.",en:"Faith comes by hearing, and hearing by the Word of God.",hr:"Vjera dolazi od slušanja, a slušanje po Božjoj riječi."}}],devotional:"Što više slušaš Riječ, vjera postaje jača.",step:"Pročitaj jedan stih naglas.",prayer:"Gospodine, ojačaj moju vjeru svojom Riječju.",declaration:"Moja vjera raste svaki dan."}
    ]}
   }
  };
 }
...
function renderDeclarations(){
 ...
 if(!root)return;
 const list=(window.declarationsData&&Array.isArray(window.declarationsData))?window.declarationsData:[];
 if(!list.length){ root.innerHTML=`<div class="card"><p>${currentLang==='fa'?'اعلان‌ها به‌زودی اضافه می‌شوند.':'Declarations will be added soon.'}</p></div>`; return; }
 const day=getDeclarationDay();
 const item=list.find(x=>x.day===day) || list[(day-1)%list.length] || list[0];
 root.innerHTML = `<div class="declaration-day-card">
  <span class="day-label">${t('declarationDay')||'Day'} ${currentLang==='fa'?toFaDigits(item.day||day):(item.day||day)}</span>
  <h2>${loc(item.title)}</h2>
  <div class="plan-section-title">${t('declarationVerse')||'Verse'}</div>
  <details class="plan-scripture-expand" open><summary>${loc(item.verse)}</summary><p>${loc(item.text)}</p></details>
  <div class="plan-section-title">${t('declarationText')||'Declaration'}</div>
  <p><strong>${loc(item.text)}</strong></p>
 </div>`;
}
...
function renderNewBirthContent(){
 ...
 if(!root)return;
 const data=(window.newBirthContentData&& (window.newBirthContentData[currentLang] || window.newBirthContentData.en)) || null;
 if(!data){ root.innerHTML=`<div class="card"><p>${currentLang==='fa'?'محتوا به‌زودی اضافه می‌شود.':'Content will be added soon.'}</p></div>`; return; }
 ...
 ${sections.map(s=>`<div class="card salvation-card"><h3>${s.title||''}</h3><p>${s.body||s.text||s.content||''}</p></div>`).join('')}
 </div>`;
}
...
const spiritualAudioItems = [
 ...
 },
 {
  "id": "teaching-001",
  "category": "teaching",
  "src": "audio/fa/teachings/001.m4a",
  "title": "احکام خدا",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-002",
  "category": "teaching",
  "src": "audio/fa/teachings/002.m4a",
  "title": "انجیل",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-003",
  "category": "teaching",
  "src": "audio/fa/teachings/003.m4a",
  "title": "ایمان انجیل",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-004",
  "category": "teaching",
  "src": "audio/fa/teachings/004.m4a",
  "title": "ارتقاء ایمان",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-005",
  "category": "teaching",
  "src": "audio/fa/teachings/005.m4a",
  "title": "اسارت در زندگی ایماندار",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-006",
  "category": "teaching",
  "src": "audio/fa/teachings/006.m4a",
  "title": "انسان روحانی و نفسانی",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-007",
  "category": "teaching",
  "src": "audio/fa/teachings/007.m4a",
  "title": "احترام به خداوند",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-008",
  "category": "teaching",
  "src": "audio/fa/teachings/008.m4a",
  "title": "۷ فایده از مشارکت با روح‌القدس",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-009",
  "category": "teaching",
  "src": "audio/fa/teachings/009.m4a",
  "title": "پسر خدا",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-010",
  "category": "teaching",
  "src": "audio/fa/teachings/010.m4a",
  "title": "تغذیه روحانی و تمرکز بر کلام",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-011",
  "category": "teaching",
  "src": "audio/fa/teachings/011.m4a",
  "title": "منابع مالی و شما",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-012",
  "category": "teaching",
  "src": "audio/fa/teachings/012.m4a",
  "title": "پنج عطیه خدمتی به کلیسا",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-013",
  "category": "teaching",
  "src": "audio/fa/teachings/013.m4a",
  "title": "چرا باید شب‌ها دعا کنیم؟",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-014",
  "category": "teaching",
  "src": "audio/fa/teachings/014.m4a",
  "title": "سفر روح‌القدس",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-015",
  "category": "teaching",
  "src": "audio/fa/teachings/015.m4a",
  "title": "سه عطیه روح خدا به روح ما",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-016",
  "category": "teaching",
  "src": "audio/fa/teachings/016.m4a",
  "title": "شکرگزاری در کلام و عمل",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-017",
  "category": "teaching",
  "src": "audio/fa/teachings/017.m4a",
  "title": "خدمتگزاری",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-018",
  "category": "teaching",
  "src": "audio/fa/teachings/018.m4a",
  "title": "خدمت مؤثر",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-019",
  "category": "teaching",
  "src": "audio/fa/teachings/019.m4a",
  "title": "عملکرد روح‌القدس",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-020",
  "category": "teaching",
  "src": "audio/fa/teachings/020.m4a",
  "title": "روز شریر",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-021",
  "category": "teaching",
  "src": "audio/fa/teachings/021.m4a",
  "title": "نکات فیض و ایمان",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-022",
  "category": "teaching",
  "src": "audio/fa/teachings/022.m4a",
  "title": "مایه برکت",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-023",
  "category": "teaching",
  "src": "audio/fa/teachings/023.m4a",
  "title": "لوسیفر / شیطان",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-024",
  "category": "teaching",
  "src": "audio/fa/teachings/024.m4a",
  "title": "عیسی کیست",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-025",
  "category": "teaching",
  "src": "audio/fa/teachings/025.m4a",
  "title": "اهمیت دعا",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-026",
  "category": "teaching",
  "src": "audio/fa/teachings/026.m4a",
  "title": "فرشتگان و پژواک حقایق",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-027",
  "category": "teaching",
  "src": "audio/fa/teachings/027.mp3",
  "title": "نور جهان هستید و پژواک حقایق",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-028",
  "category": "teaching",
  "src": "audio/fa/teachings/028.m4a",
  "title": "اتحاد قلبی",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 },
 {
  "id": "teaching-029",
  "category": "teaching",
  "src": "audio/fa/teachings/029.m4a",
  "title": "ذهن، فکر، سخن گفتن",
  "desc": "تعلیم صوتی برای رشد در کلام، ایمان و زندگی روحانی.",
  "tag": "تعلیم"
 }
];
...
function renderSpiritualAudioFeature(){
 ...
 const targets=[
   home.querySelector('.home-feature-grid'),
   home.querySelector('#homeContent'),
   home.querySelector('.hero-card')?.parentNode,
   home
 ].filter(Boolean);
 const target=targets[0];
 if(target.classList && target.classList.contains('home-feature-grid')) target.prepend(card);
 else if(home.querySelector('.hero-card')) home.querySelector('.hero-card').insertAdjacentElement('afterend', card);
