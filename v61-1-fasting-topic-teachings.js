/* Omideno7 V61.1 — Fasting topic teachings + stable Scripture toggles
...
(function(){
  ...
  function patchStart(){
    ...
    if(!preview) return;
    const update=()=>{ const {type,topic}=selectedTypeTopic(); preview.innerHTML=renderBlock(type,topic,false); };
  ...
  function patchActive(){
    ...
    block.innerHTML=renderBlock(active.type,active.topic,false);
  ...
  function addStyle(){
    ...
    st.textContent='.v61-topic-block h3{margin-top:1rem}.v61-topic-block p{line-height:1.9}.v61-full-verse{margin:.45rem 0;border:1px solid rgba(10,30,90,.12);border-radius:14px;padding:.35rem .75rem;background:#fff}.v61-full-verse summary{cursor:pointer;font-weight:700}.v61-full-verse p{white-space:pre-wrap;line-height:1.9;margin:.7rem 0}.v61-topic-block{border:1px solid rgba(29,91,79,.18);box-shadow:0 10px 28px rgba(29,91,79,.08)}';
