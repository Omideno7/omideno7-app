/* Omid No 7 Web App - V50 Fasting Journey / سفر روزه
   V53: Fasting journey with clearer header contrast. */
(function(){
  'use strict';
  ...
  function injectStyle(){
    ...
    const st=document.createElement('style'); st.id='fastingJourneyStyleV50'; st.textContent=`
      .fasting-hero{background:linear-gradient(145deg,#f8faf7,#fff7df);color:#10223f;border:1px solid rgba(200,169,74,.35);border-radius:26px;padding:24px;margin:14px 0;box-shadow:0 18px 45px rgba(0,0,0,.18)}
      .fasting-hero h1{margin:.2rem 0 .4rem;font-size:1.7rem;color:#1d5b4f}.fasting-hero .small{color:#9a7b1f;font-weight:800}.fasting-hero p{opacity:1;line-height:1.9;color:#334155}.fasting-grid{display:grid;grid-template-columns:1fr;gap:12px;margin:16px 0}.fasting-card,.fasting-action,.fasting-stat{background:#fff;border:1px solid rgba(16,34,63,.08);border-radius:20px;padding:16px;box-shadow:0 10px 28px rgba(16,34,63,.08)}
  ...
  function renderTeaching(){
    root().innerHTML=`<div class="fasting-hero"><h1>روزه در مسیحیت چیست؟</h1><p>تعلیم کوتاه برای درک هدف روزه در زندگی ایماندار</p></div>
    <div class="fasting-card fasting-teaching">
      <p><strong>روزه مسیحی فقط نخوردن غذا نیست؛ روزه یعنی جدا کردن زمان برای خداوند، تمرکز بر کلام، دعا، تعمق و مطیع ساختن جسم زیر هدایت روح خدا.</strong></p>
      <p>ما به عنوان ایمانداران و شاگردان مسیح روزه می‌گیریم تا جسم، افکار، خواسته‌ها و عادت‌های خود را زیر اطاعت روح خدا قرار دهیم. روزه ما مسیحیان جنبه مذهبی، نمایشی یا اجباری ندارد. ما روزه نمی‌گیریم تا خدا را مجبور کنیم کاری انجام دهد، و روزه نمی‌گیریم تا به خدا ثابت کنیم روحانی‌تر یا مقدس‌تر هستیم. ما در مسیح، تقدس، عدالت و پذیرش خود را از طریق قربانی کامل عیسی دریافت کرده‌ایم.</p>
      <details class="fasting-scripture" open><summary>متی ۶:۱۶-۱۸</summary><p>«وقتی روزه می‌گیرید مانند ریاکاران، خودتان را پریشان نشان ندهید. آنان قیافه‌های خود را تغییر می‌دهند تا روزه‌دار بودن خود را به رخ دیگران بکشند. یقین بدانید که آنها اجر خود را یافته‌اند! اما تو وقتی روزه می‌گیری، سر خود را شانه کن و صورت خود را بشوی تا مردم از روزه تو باخبر نشوند، بلکه فقط پدر تو که در نهان است، آن را بداند و پدری که هیچ چیز از نظر او پنهان نیست، اجر تو را خواهد داد.»</p></details>
      <p>عیسی در این آیات نگفت: «اگر روزه گرفتید»، بلکه گفت: «وقتی روزه می‌گیرید». این نشان می‌دهد که روزه بخشی از زندگی روحانی ایماندار است؛ اما عیسی هم‌زمان هشدار داد که روزه نباید برای نمایش، ریاکاری یا جلب توجه مردم انجام شود. روزه حقیقی در حضور پدر انجام می‌شود، نه برای دیده شدن توسط انسان‌ها.</p>
      <p>وقتی از «جسم» صحبت می‌کنیم، فقط منظور بدن فیزیکی نیست؛ بلکه طرز فکر طبیعی، تمایلات نفسانی، عادت‌های قدیمی، احساسات کنترل‌نشده و واکنش‌هایی است که می‌خواهند برخلاف هدایت روح‌القدس حرکت کنند. روزه به ما کمک می‌کند این بخش‌ها را آرام کنیم تا روح ما نسبت به خداوند حساس‌تر و مطیع‌تر شود.</p>
      <details class="fasting-scripture"><summary>متی ۴:۱-۱۱</summary><p>عیسی قبل از شروع خدمت زمینی خود، در بیابان روزه گرفت و سپس با وسوسه‌های شیطان روبه‌رو شد. او با کلام خدا پاسخ داد و نشان داد که انسان با نان تنها زندگی نمی‌کند، بلکه با هر کلامی که از دهان خدا صادر می‌شود.</p></details>
      <p>عیسی روزه نگرفت تا پدر از او راضی و خشنود شود؛ زیرا قبل از روزه، وقتی روح‌القدس بر او قرار گرفت، پدر اعلام کرد: «این است پسر محبوب من که از او خشنودم.» پس روزه برای به دست آوردن محبت خدا نیست. خدا در مسیح ما را پذیرفته است. روزه ابزاری روحانی است تا ما با تمرکز بیشتر، اطاعت عمیق‌تر و حساسیت بیشتر نسبت به روح‌القدس زندگی کنیم.</p>
      <p>روزه به ما کمک می‌کند راحت‌تر تمایلات روح‌القدس را در زندگی خود به مرحله عمل درآوریم. اگر دائماً از جسم، احساسات، عادت‌های قدیمی و افکار طبیعی پیروی کنیم، انجام دادن خواسته‌های روح‌القدس برای ما دشوار می‌شود. اما وقتی در روزه، دعا و کلام می‌مانیم، روح ما قوی‌تر می‌شود و صدای خدا را شفاف‌تر تشخیص می‌دهیم.</p>
      <details class="fasting-scripture"><summary>غلاطیان ۵:۱۶</summary><p>«به روح رفتار کنید تا شهوات جسم را به‌جا نیاورید.»</p></details>
      <p>روزه باعث می‌شود درون ما پاک‌تر، متمرکزتر و آماده‌تر شود تا قدرت و جلال خداوند بیشتر در زندگی ما آشکار گردد. روزه جای کلام خدا، ایمان، اطاعت یا محبت را نمی‌گیرد؛ بلکه به ما کمک می‌کند این چیزها را با تمرکز و جدیت بیشتری زندگی کنیم.</p>
      <h3>هدف‌های اصلی روزه مسیحی</h3>
      <ul>
        <li>تمرکز قلب بر خداوند و کلام او</li>
        <li>قوی‌تر شدن روح و ضعیف شدن تسلط جسم</li>
        <li>حساس‌تر شدن نسبت به هدایت روح‌القدس</li>
        <li>آمادگی برای خدمت، تصمیم‌های مهم و مأموریت الهی</li>
        <li>تعمق در کلام و دریافت مکاشفه روشن‌تر</li>
        <li>دعا برای خانواده، کلیسا، نجات جان‌ها، شفا و بیداری روحانی</li>
      </ul>
      <p><strong>پس روزه مسیحی یک قانون مذهبی برای محکومیت نیست؛ یک مسیر روحانی برای تمرکز، اطاعت، دعا، کلام و رشد در روح است.</strong></p>
    </div>
