...
V38:
- Removed Apocrypha section temporarily.
- Removed Persian Audio Bible placeholder.
- Removed temporary bottom notes/conversation-style texts from Bible page.
- Fixed Persian click navigation using document-level event delegation.
- Old Testament, New Testament, and reading plans now open in Persian, English, and Croatian.
- Kept existing Persian, English, and Croatian Bible texts.
Test URL:
https://omideno7.github.io/omideno7-app/?v=38

V39:
- Split the large Bible data file into smaller language/testament files so GitHub can serve and manage them more reliably.
- Removed the visible message: "This plan is based on the uploaded table" from reading plans in all languages.
- Kept Apocrypha and Persian audio placeholder removed.
- Kept Persian, English, and Croatian Bible texts for Old and New Testaments.
Test URL:
https://omideno7.github.io/omideno7-app/?v=39

V40:
- Persian Bible data is now split into one small file per book inside bible-fa-v40/.
- This avoids the mobile GitHub/GitHub Pages loading issue caused by large Persian JS files.
- Removed the visible reading-plan source note in all languages.
- Kept Old Testament and New Testament only; Apocrypha and Persian audio are still removed.
- Persian, English, and Croatian reading text remain available inside the app.
Test URL:
https://omideno7.github.io/omideno7-app/?v=40

V41:
- Bible reading plan now shows only the one-year plan in Persian, English, and Croatian.
- Removed the two-year plan from the visible UI.
- Added the Thanksgiving course to the Plans tab.
- Removed the Thanksgiving course card from Home and More.
- The Thanksgiving course page and its existing system/content remain unchanged.
Test URL:
https://omideno7.github.io/omideno7-app/?v=41

V42:
- Cache-bust fix: index now loads app-v42.js and styles-v42.css instead of cached app-v14.js/styles-v14.css.
- Added global fallback click handler for Bible section cards, book cards, and reading plan cards.
- This fixes cases where Safari/GitHub Pages kept old JavaScript and Persian cards did not open.
Test URL:
https://omideno7.github.io/omideno7-app/?v=42

V43:
- Added direct inline click handlers to Bible section cards, book cards, one-year reading plan, and plan chapter buttons.
- Added hard cache-busting: app-v43.js, styles-v43.css, and ?v=43 on scripts/styles.
- Added reset option: open ?v=43&reset=1 once to clear old Bible view state.
- Unregisters old service worker/cache on load to avoid stale app code.
Test URL:
https://omideno7.github.io/omideno7-app/?v=43&reset=1

V44:
- Hardwired Bible UI buttons: Old Testament, New Testament, book cards, verse tools, and reading plan chapters now call functions directly through window.*.
- Restored/kept verse tools: note, bold, highlight, bookmark, read marker.
- Removed residual Apocrypha logic from Bible reader navigation.
