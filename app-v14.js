...
function renderBibleReader(){
 ...
 if(bibleReaderView==='home'){
   ...
   <div class="bible-section-grid">
     ${sections.map(sec=>`<button type="button" class="bible-section-card " data-bible-section="${sec.id}">
       <span class="bible-section-icon">${sec.id==='old'?'◈':'✦'}</span>
