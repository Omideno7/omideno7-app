/* Omideno7 V59.4 - Stable Install Guide + Admin entry helper
...
(function(){
  ...
  function updateInstallText(){
    ...
    const v=document.getElementById('appVersion'); if(v) v.textContent=tr('version');
  }
