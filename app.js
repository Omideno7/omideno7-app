...
const translations={en:{dailyKicker:'Daily Word. Prayer. Faith.',homeTitle:'Welcome to Omid No 7 Church',homeDesc:'An online Persian and English Christian church based in Zagreb, Croatia, committed to teaching God’s Word, prayer, discipleship, and equipping believers for God’s Kingdom.',todayWordTitle:'Today’s Daily Word',joinMeeting:'Join Online Meeting',callToJoin:'Call to Join',enableNotifications:'Enable Notifications',notificationInfo:'Receive Daily Word and meeting reminders on your phone.',notificationReady:'Notifications are ready. Tap Allow if your device asks for permission.',notificationUnsupported:'Notifications are not supported on this browser. On iPhone, install the app to Home Screen first.',morningPrayer:'Daily Morning Prayer',sundayService:'Sunday Church Service',croatiaTime:'Croatia time',meetingsTitle:'Online Meetings',meetingsDesc:'Join our online meetings through FreeConferenceCall.',scheduleTitle:'Weekly Schedule',prayerTitle:'Prayer Request',prayerDesc:'Send your prayer request to our ministry team. We would be glad to pray with you.',membershipTitle:'Membership',membershipDesc:'To join, request prayer, or contact us, please complete the form below.',givingTitle:'Give & Support',givingDesc:'Your giving helps us share the Gospel, teach God’s Word, support online ministry, and raise strong believers for God’s Kingdom.',moreTitle:'More',faithTitle:'Our Faith & Vision',faithDesc:'Rooted in the Word. Led by the Spirit.',installTitle:'Install This App',installDesc:'Open this website on your phone and add it to your Home Screen.',footer:'Built on Christ. Led by the Spirit.',submit:'Send'},fa:{dailyKicker:'کلام روزانه، دعا، ایمان',homeTitle:'به کلیسای امیدنو۷ خوش آمدید',homeDesc:'کلیسای آنلاین مسیحی به زبان‌های فارسی و انگلیسی، مستقر در زاگرب کرواسی، با تمرکز بر تعلیم کلام خدا، دعا، شاگردسازی و تجهیز ایمانداران برای پادشاهی خدا.',todayWordTitle:'پیام روزانه امروز',joinMeeting:'ورود به جلسه آنلاین',callToJoin:'ورود با تماس تلفنی',enableNotifications:'فعال‌سازی اعلان‌ها',notificationInfo:'پیام روزانه و یادآوری جلسات را روی گوشی دریافت کنید.',notificationReady:'اعلان‌ها آماده است. اگر گوشی اجازه خواست، Allow را بزنید.',notificationUnsupported:'اعلان‌ها در این مرورگر پشتیبانی نمی‌شود. در آیفون، ابتدا اپ را به Home Screen اضافه کنید.',morningPrayer:'دعای صبح روزانه',sundayService:'جلسه کلیسا یکشنبه‌ها',croatiaTime:'به وقت کرواسی',meetingsTitle:'جلسات آنلاین',meetingsDesc:'از طریق FreeConferenceCall به جلسات آنلاین کلیسای امیدنو۷ بپیوندید.',scheduleTitle:'برنامه هفتگی',prayerTitle:'درخواست دعا',prayerDesc:'درخواست دعای خود را برای تیم خدمتی ما بفرستید. با شادی برای شما دعا می‌کنیم.',membershipTitle:'عضویت',membershipDesc:'برای عضویت، درخواست دعا یا ارتباط با ما، فرم زیر را تکمیل کنید.',givingTitle:'هدایا و حمایت',givingDesc:'هدایای شما به ما کمک می‌کند انجیل را گسترش دهیم، کلام خدا را تعلیم دهیم، خدمت آنلاین را حمایت کنیم و ایماندارانی قوی برای پادشاهی خدا تربیت نماییم.',moreTitle:'بیشتر',faithTitle:'ایمان و رؤیای ما',faithDesc:'ریشه‌دار در کلام، هدایت‌شده با روح.',installTitle:'نصب اپ',installDesc:'این سایت را روی گوشی باز کنید و آن را به صفحه اصلی اضافه کنید.',footer:'بنا شده بر مسیح، هدایت‌شده با روح‌القدس.',submit:'ارسال'}};
...
async function enableNotifications(){
  updateNotificationStatus(translations[currentLang].notificationReady);
  window.OneSignalDeferred = window.OneSignalDeferred || [];
  OneSignalDeferred.push(async function(OneSignal) {
    try {
      if (!OneSignal.Notifications.isPushSupported()) {
        updateNotificationStatus(translations[currentLang].notificationUnsupported);
        return;
      }
      if (OneSignal.Notifications.permission) {
        updateNotificationStatus(currentLang==='fa'?'اعلان‌ها قبلاً فعال شده‌اند.':'Notifications are already enabled.');
        return;
      }
      ...
      updateNotificationStatus(currentLang==='fa'?'خطا در فعال‌سازی اعلان‌ها. دوباره تلاش کنید.':'Could not enable notifications. Please try again.');
      console.error(e);
    }
  });
}
